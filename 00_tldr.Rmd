...
Une fonction est mise à disposition pour réaliser vos cartes.
Les paramètres ne sont pas modifiables au-delà de ce qui est déjà inclus, mais la réalisation de carte est clé-en-main et s'en retrouve facilitée.

Il suffit de suivre la checklist suivante :

+ import de vos données avec une ligne = une unité géographique avec son identifiant et une valeur à afficher ;
+ rentrer les paramètres et exécuter la fonction.
