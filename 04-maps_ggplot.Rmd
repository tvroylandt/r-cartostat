...
--> FAIRE UNE VERSION SIMPLIFIEE DANS UNE FONCTION
AVEC JUSTE CHOIX DU FOND DE CARTE, JEU DE DONNEES, VARIABLE A AFFICHER, CARTE COULEUR OU ROND, DOSSIER DE L'EXPORT
...
```{r, include=FALSE}
reg_shp <- st_read(here("data/shp/REG_2018_FR_ENT.shp"))
```
